...
export const AvatarScene: React.FC<AvatarSceneProps> = ({ 
  ...
  useEffect(() => {
    ...
    activeExtraActionIndexRef.current = activeExtraActionIndex;
  }, [activeExtraActionIndex, isTalking]);
  ...
  useEffect(() => {
    setWebglError(null);
  }, [modelUrl, idleModelUrl, talkingModelUrl, waveModelUrl]);
  ...
  }, [idleModelUrl, talkingModelUrl, modelUrl, faceDebugEnabled, faceAnchorCacheKey, faceAnchorRefreshToken]); //        URL
  ...
  }, [activeExtraActionIndex, extraActionModelUrls, idleReadyVersion]);
  ...
  useEffect(() => {
    ...
    resumePrimaryAction();
  }, [activeExtraActionIndex, isTalking, idleModelUrl, primaryActionReadyVersion, talkingModelUrl]);
