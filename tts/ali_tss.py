...
class Speech:
    ...
    def to_sample(self, text, style) :
        file_url = None
        try:
            history = self.__get_history(config_util.config["attribute"]["voice"] if config_util.config["attribute"]["voice"] is not None and config_util.config["attribute"]["voice"].strip() != "" else "zhifeng_emo", style, text)
